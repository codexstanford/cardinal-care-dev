...
function updatePolicyMultiselectButtons() {
    let policy_multiselect_buttons = document.getElementsByClassName("policy-multiselect-button");
    for (let multiselect_button of policy_multiselect_buttons) {
        // Selected
        if (selected_policies.has(multiselect_button.textContent)) {
...
function saveResponses() {
    ...
    let facts_to_add = "";
    let coverage_start_date_input_widget = document.getElementById("coverage-start-date-input");
    let coverage_end_date_input_widget = document.getElementById("coverage-end-date-input");
...
function coverageDatesAreValid() {
    let coverage_start_date_input_widget = document.getElementById("coverage-start-date-input");
    let coverage_end_date_input_widget = document.getElementById("coverage-end-date-input");
